# Tekton with Persistent Volume Claim (PVC) as cache

This guide explains how to use `btdt` in a [Tekton](https://tekton.dev/) pipeline with a Persistent Volume Claim (PVC)
as cache.
...
## Provide a PVC as workspace to the pipeline run
